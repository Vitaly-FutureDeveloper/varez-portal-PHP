        ...
        <h1><?= $titleH1 ?></h1>
            <section class="header-pro">
                <blockquote class="wellcome">
                    ...
                    <div class="header-info timer"><? echo "<p>Последнее посещение: $lastVisit</p>"; ?></div>
                </blockquote>
            ...
            <button class="past-form">Править страницу:</button>
                <div class="form-insert-paste">
                        <form method="post" action="inc/index.inc.php">
                            ...
                            <legend>
                                Править страницу:
                                <img src="/img/icons/ask.png" width="25px" title="Контент будет отображаться вначале страницы, применять можно любые теги... Добавлять и редактировать каждую строку...">
                            </legend>
                            
                                <input type="hidden" name="userlogin" value="<?= $userlogin ?>"><!--Логин написавшего-->
                                <input type="hidden" name="timer" value="<?= $timer ?>"><!--Время-->
                                ...
                                <Label><p></p>
                                <textarea name="text" class="postform-textarea"><? showContent ($titleArray, $id, 0); ?></textarea></Label>
                                <Label><p><button type="submit" name="button" value="add">Добавить</button></p></Label>
                                <Label><p><button type="submit" name="button" value="redact">Редактировать</button></p></Label>
                            </fieldset>
                        </form>
            <?  }   else{
